...
export const projects: Project[] = [
  {
    ...
    cat: 'web3',
    meta: 'AI AGENTS · 2024',
    blurb: 'Building the internet of agents — the multi-rail distribution engine and economic layer for the agent economy on Linea.',
  ...
  },
  {
    ...
    cat: 'web3',
    meta: 'EXPLORER · 2019',
    blurb: 'Cosmos ecosystem navigator for developers and investors — tracking chain activity, validators and token flows.',
  ...
  },
  {
    ...
    blurb: 'Trading tool implementing a mean-reversion strategy — signals, screening and backtests.',
    cover: meanReversion,
    coverPos: 'top',
